...
export default function Profile() {
  ...
  return (
    <div className="dark min-h-screen bg-zinc-950">
      ...
      {/* Banner */}
      <div className="relative h-48 bg-gradient-to-r from-pink-900/40 to-purple-900/40 mt-16">
      ...
      <main className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end -mt-12 mb-8">
          <div className="relative">
            ...
            <label className="absolute -bottom-1 -right-1 w-7 h-7 bg-pink-500 rounded-lg flex items-center justify-center cursor-pointer hover:bg-pink-600 transition-colors">
