      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            {/* Logo */}
            <Link to={createPageUrl('Home')} className={`flex items-center gap-2 absolute left-1/2 -translate-x-1/2 lg:static lg:left-auto lg:translate-x-0 transition-all duration-300 ${atTop ? 'pt-20 md:pt-0' : ''}`}>
              <img
